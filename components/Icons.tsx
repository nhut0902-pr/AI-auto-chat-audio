...
export const MicIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5v1.5a7.5 7.5 0 11-15 0v-1.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75a.75.75 0 00.75-.75v-4.5a.75.75 0 00-1.5 0v4.5a.75.75 0 00.75.75z" />
    </svg>
);
...
export const GeminiIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path d="M21.7333 13.56L16.2 3.48C15.9333 3.02667 15.3467 3.02667 15.08 3.48L9.54667 13.56C9.28 14.0133 9.57333 14.5467 10.1067 14.5467H21.1733C21.7067 14.5467 22 14.0133 21.7333 13.56Z" fill="url(#paint0_linear_101_10)"/>
        <path d="M12.2933 28.52L6.76 18.44C6.49333 17.9867 6.78667 17.4533 7.32 17.4533H18.3867C18.92 17.4533 19.2133 17.9867 18.9467 18.44L13.4133 28.52C13.1467 28.9733 12.56 28.9733 12.2933 28.52Z" fill="url(#paint1_linear_101_10)"/>
        <defs>
            <linearGradient id="paint0_linear_101_10" x1="15.64" y1="3.2" x2="15.64" y2="14.5467" gradientUnits="userSpaceOnUse">
                <stop stopColor="#A8C7FA"/>
                <stop offset="1" stopColor="#81A3F9"/>
            </linearGradient>
            <linearGradient id="paint1_linear_101_10" x1="12.8533" y1="17.4533" x2="12.8533" y2="28.8" gradientUnits="userSpaceOnUse">
                <stop stopColor="#F9BC05"/>
                <stop offset="1" stopColor="#F7B30C"/>
            </linearGradient>
        </defs>
    </svg>
);
